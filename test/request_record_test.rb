...
class RequestRecordTest < ActiveSupport::TestCase
  ...
  test "record" do
    ...
    record = Beacnox::Models::RequestRecord.from_db(key, nil)
    assert_equal record.controller, "HomeController"
    assert_equal record.status, "200"
