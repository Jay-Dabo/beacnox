module Beacnox
  module Gems
    class DelayedJobExt
      class Plugin < ::Delayed::Plugin
        callbacks do |lifecycle|
          lifecycle.around(:invoke_job) do |job, *args, &block|
            ...
            meta_data = Beacnox::Gems::DelayedJobExt::Plugin.meta(job.payload_object)
            record = Beacnox::Models::DelayedJobRecord.new(
              jid: job.id,
      ...
      def self.init
        ::Delayed::Worker.plugins += [::Beacnox::Gems::DelayedJobExt::Plugin]
      end
    end
  end
end
