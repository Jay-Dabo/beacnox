  ...
  module Models
    class DelayedJobRecord < BaseRecord
      ...
      def record_hash
        {
          jid: jid,
          datetime: Beacnox::Utils.from_datetimei(datetimei),
          datetimei: datetimei,
      ...
      def save
        key = "delayed_job|jid|#{jid}|datetime|#{datetime}|datetimei|#{datetimei}|source_type|#{source_type}|class_name|#{class_name}|method_name|#{method_name}|status|#{status}|END|#{Beacnox::SCHEMA}"
