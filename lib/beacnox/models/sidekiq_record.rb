module Beacnox
  module Models
    class SidekiqRecord < BaseRecord
      ...
      def record_hash
        {
          ...
          status: status,
          datetimei: datetimei,
          datetime: Beacnox::Utils.from_datetimei(start_timei.to_i),
      ...
      def save
        key = "sidekiq|queue|#{queue}|worker|#{worker}|jid|#{jid}|datetime|#{datetime}|datetimei|#{datetimei}|enqueued_ati|#{enqueued_ati}|start_timei|#{start_timei}|status|#{status}|END|#{Beacnox::SCHEMA}"
