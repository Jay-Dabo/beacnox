      ...
      def data
        collect do |k, v|
          ...
          db_runtimes = v.collect { |e| e["db_runtime"] }.compact
          {
            ...
            p50_duration: Beacnox::Utils.percentile(durations, 50),
            p95_duration: Beacnox::Utils.percentile(durations, 95),
            p99_duration: Beacnox::Utils.percentile(durations, 99)
          }
